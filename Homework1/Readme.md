This repository contains the source code for Assignment 1, which is organized into three distinct sections. Each section of the assignment has its own Jupyter Notebook.
